        ...
        <FlagArea title="Republic Of Artsakh">
            ...
            <DescriptionSection title="Sources">
                <ul className="citation-list">
                    <li>
                        Wikipedia: <ExternalLink href="https://en.wikipedia.org/wiki/Flag_of_the_Republic_of_Artsakh">"Flag of the Republic of Artsakh"</ExternalLink>
                    </li>
                </ul>
            </DescriptionSection>
        </FlagArea>
...
export default RepublicOfArtsakh;
