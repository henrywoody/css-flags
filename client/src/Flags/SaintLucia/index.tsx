    ...
    return (
        <FlagArea title="Saint Lucia">
            ...
            <DescriptionSection title="Construction">
                <p>
                    Created with a blue <code>background-color</code> and a <code>conic-gradient</code> for each of the three triangles.
                </p>
            </DescriptionSection>
            ...
            <DescriptionSection title="Sources">
                <ul className="citation-list">
                    <li>
                        Scheme Color: <ExternalLink href="https://www.schemecolor.com/saint-lucia-flag-colors.php">"Saint Lucia Flag Colors"</ExternalLink>
                    </li>
                    <li>
                        Vexilla Mundi: <ExternalLink href="http://www.vexilla-mundi.com/saint_lucia_flag.html">"Saint Lucia"</ExternalLink>
                    </li>
                    <li>
                        Wikipedia: <ExternalLink href="https://en.wikipedia.org/wiki/Flag_of_Saint_Lucia">"Flag of Saint Lucia"</ExternalLink>
                    </li>
                </ul>
            </DescriptionSection>
        </FlagArea>
