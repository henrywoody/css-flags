        ...
        <FlagArea title="Japan" flagName="日章旗 (Nisshōki—Flag of Sun) | 日の丸 (Hinomaru—Circle of the Sun)">
            ...
            <DescriptionSection title="Sources">
                <ul className="citation-list">
                    <li>
                        Scheme Color: <ExternalLink href="https://www.schemecolor.com/japan-flag-colors.php">"Japan Flag Colors"</ExternalLink>
                    </li>
                    <li>
                        Wikipedia: <ExternalLink href="https://en.wikipedia.org/wiki/Flag_of_Japan">"Flag of Japan"</ExternalLink>
                    </li>
                </ul>
            </DescriptionSection>
        </FlagArea>
