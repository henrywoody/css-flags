        ...
        <FlagArea title="North Macedonia">
            ...
            <DescriptionSection title="Sources">
                <ul className="citation-list">
                    <li>
                        Wikipedia: <ExternalLink href="https://en.wikipedia.org/wiki/Flag_of_North_Macedonia">"Flag of North Macedonia"</ExternalLink>
                    </li>
                </ul>
            </DescriptionSection>
        </FlagArea>
