        ...
        <FlagArea title="Switzerland">
            ...
            <DescriptionSection title="Sources">
                <ul className="citation-list">
                    <li>
                        Wikipedia: <ExternalLink href="https://en.wikipedia.org/wiki/Flag_of_Switzerland">"Flag of Switzerland"</ExternalLink>
                    </li>
                </ul>
            </DescriptionSection>
        </FlagArea>
