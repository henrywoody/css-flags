...
import { IslamicRepublicOfMauritania } from "./IslamicRepublicOfMauritania";
...
export const flags: React.ReactElement[] = [
    <Algeria key="algeria" />,
    ...
    <Guyana key="guyana" />,
    <Iceland key="iceland" />,
    <IslamicRepublicOfMauritania key="islamic-republic-of-mauritania" />,
    <Israel key="israel" />,
    <Jamaica key="jamaica" />,
    <Japan key="japan" />,
    <Kuwait key="kuwait" />,
